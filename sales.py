...
class salesclass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text="clear",command=self.clear,font=("times new roman",15,"bold"),bg="light gray",fg="black",cursor="hand2").place(x=490,y=100,width=120,height=28)
       ...
       #=======Bill Area=========
        ...
        #======Image======
        self.bill_photo=Image.open("projectphotos/cat2.jpg")
