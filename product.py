...
class productClass:
    def __init__(self,root):
        ...
        lbl_product_name=Label(self.root,text="Name",font=("goudy old style",15),bg="white").place(x=30,y=160)
        ...
        txt_quantity=Entry(product_Frame,textvariable=self.var_qty,font=("goudy old style",15),bg="lightyellow").place(x=150,y=250,width=200)
